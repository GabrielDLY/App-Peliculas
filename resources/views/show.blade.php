...
@section('content')
    <div class="movie-info border-b border-gray-700">
        <div class="container mx-auto px-4 py-16 grid">
            <img src="/img/thething.jpg" alt="thething" class="w-70 md:w-96">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold py-10">The Thing (1982)</h2>
                <div class="flex flex-wrap items-center text-gray-500 text-sm">
                    ...
                    <span class="mx-2">|</span>
                    <span>Terror, Misterio, Ciencia Ficción</span>
                </div>
